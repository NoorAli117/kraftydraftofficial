...
protocol RecentlyTappedModelProtocol: class {
    func itemsDownloaded(items: NSArray)
}

class RecentlyTappedModel: NSObject {
    
    //properties
    
    weak var delegate: RecentlyTappedModelProtocol!
    
    let urlPath = "\(URL_RECENTLY_TAPPED)"
