//
//  BeerSpecialModel.swift
//  KraftyDraftOfficial
//
//  Created by Richard Miller on 4/11/18.
...
protocol BeerSpecialModelProtocol: class {
    func itemsDownloaded(specialbeer: NSArray)
}

class BeerSpecialModel: NSObject {
    
    //properties
    
    weak var delegate: BeerSpecialModelProtocol!
    
    let urlPath = "\(URL_CUST_SPECIAL)"
    ...
    func parseJSON(_ data:Data) {
        ...
        DispatchQueue.main.async(execute: { () -> Void in
            ...
            self.delegate.itemsDownloaded(specialbeer: beers)
