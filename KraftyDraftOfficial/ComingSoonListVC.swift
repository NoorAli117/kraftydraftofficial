//
//  ComingSoonListVC.swift
//  KraftyDraftOfficial
//
//  Created by Aakif Nadeem on 20/11/2023.
...
class ComingSoonListVC: UIViewController, UITableViewDelegate, UITableViewDataSource, ComingSoonModelProtocol, UISearchBarDelegate {
    
    var selectedDark : ComingSoonModel = ComingSoonModel()
    let user = Auth.auth().currentUser
    let beerModel = ComingSoonModel()
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "ComingSoonBeerDetail", sender: self)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "ComingSoonBeerDetail" {
...
extension ComingSoonListVC : IndicatorInfoProvider {
