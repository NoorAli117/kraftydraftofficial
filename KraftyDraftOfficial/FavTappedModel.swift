...
protocol FavTappedModelProtocol: class {
    func itemsDownloaded(items: NSArray)
}

class FavTappedModel: NSObject {
    
    //properties
    
    weak var delegate: FavTappedModelProtocol!
    
    let urlPath = "\(URL_FAV_TAPPED)"
