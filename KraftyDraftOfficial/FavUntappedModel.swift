...
protocol FavUntappedModelProtocol: class {
    func itemsDownloaded(items: NSArray)
}

class FavUntappedModel: NSObject {
    
    //properties
    
    weak var delegate: FavUntappedModelProtocol!
    
    let urlPath = "\(URL_FAV_UNTAPPED)"
