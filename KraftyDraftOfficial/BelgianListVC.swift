...
class BelgianListVC: UIViewController, UITableViewDelegate, UITableViewDataSource, BelgianModelProtocol, UISearchBarDelegate {
    
    var selectedBelgian : BelgianModel = BelgianModel()
    let user = Auth.auth().currentUser
    let beerModel = BelgianModel()
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "BelgianBeerDetail", sender: self)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "BelgianBeerDetail" {
...
extension BelgianListVC : IndicatorInfoProvider {
    
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(title: "BELGIAN")
    }
}
