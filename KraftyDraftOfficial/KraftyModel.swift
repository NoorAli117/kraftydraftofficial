...
protocol KraftyModelProtocol: class {
    func itemsDownloaded(items: NSArray)
}

class KraftyModel: NSObject {
    
    //properties
    
    weak var delegate: KraftyModelProtocol!
    
    let urlPath = "\(URL_CUST_KRAFTY)"
