...
class EntreesListVC: UIViewController, UITableViewDelegate, UITableViewDataSource, EntreeModelProtocol {

    var selectedEntree : EntreesModel = EntreesModel()
...
//        tableView.estimatedRowHeight = 125.0
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "EntreeDetail", sender: self)
        
    }
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "EntreeDetail" {
...
extension EntreesListVC : IndicatorInfoProvider {
    
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        return IndicatorInfo(title: "PUB")
    }
}
