...
protocol ComingSoonModelProtocol: class {
    func itemsDownloaded(items: NSArray)
}

class ComingSoonModel: NSObject {
    
    //properties
    
    weak var delegate: ComingSoonModelProtocol!
    
    let urlPath = "\(URL_CUST_COMINGSOON)"
    ...
    func parseJSON(_ data:Data) {
        ...
        DispatchQueue.main.async(execute: { () -> Void in
            ...
            self.delegate.itemsDownloaded(items: beers)
